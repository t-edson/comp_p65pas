...
A notable difference from the Pascal used by the compiler is that array literals are all defined using square brackets instead of parentheses, even when initializing constants.
